    ...
    steps: [
      {
        ...
        title: '建筑总体概况',
        narration: [
          '乐盈广场21号楼：地上 40 层、地下 1 层，集商业、餐饮、影院、办公、配套、客房于一体。',
          '按竖向分区掌握：地下设备区（B1）→ 低区（1-13F：首层大堂/商业/餐饮/影院/办公）→ 中区（14-25F：配套用房/避难层）→ 高区（26-40F：客房）。',
        ],
        whole: true,
      },
      {
      ...
      },
      {
        ...
        title: '高区（26-40F）',
        narration: [
          '高区客房层（26-40F）由高速电梯组服务，消防电梯全楼可达；本区疏散中转依托 25F 避难层。',
          '高区疏散以向下经防烟楼梯间为主——内攻时消防电梯只停靠着火层下两层，再换乘楼梯进攻。',
        ],
        floorSpec: '38-40F',
