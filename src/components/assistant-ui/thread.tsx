        ...
        <AuiIf condition={(s) => !s.thread.isRunning}>
          <ComposerPrimitive.Send asChild>
            <TooltipIconButton
              ...
              variant="default"
              size="icon"
              className="aui-composer-send size-7 rounded-full bg-cyan text-bg-deep hover:brightness-110"
              aria-label="发送"
            >
  ...
  return (
    ...
    >
      ...
      <div className="aui-user-message-content-wrapper relative col-start-2 min-w-0">
        <div className="aui-user-message-content peer border-cyan/40 bg-cyan/10 text-foreground rounded-2xl border px-3.5 py-2 text-sm wrap-break-word empty:hidden">
